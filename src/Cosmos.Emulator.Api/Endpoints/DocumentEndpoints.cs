...
public static class DocumentEndpoints
{
    ...
    */
    ...
    /// For ORDER BY queries, we must rewrite the query to the orderByItems/payload format
    /// that the SDK's StreamingOrderByCrossPartitionQueryPipelineStage expects.
    /// </summary>
